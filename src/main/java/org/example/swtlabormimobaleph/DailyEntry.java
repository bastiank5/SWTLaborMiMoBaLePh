...
public class DailyEntry implements Serializable {
    ...
    public DailyEntry(LocalDate date, LocalTime begin, LocalTime end, LocalTime pause, Absence absence, String comment, float diff, String weekday, float hoursTarget, float hoursAsIs) {
        this.date = date;
        this.begin = begin;
        this.end = end;
        this.pause = pause;
